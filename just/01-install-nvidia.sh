...
# Modified by https://github.com/alessandrofrenna
#
# ==============================================================================
add_env_variables() {
  echo -e "Adding environmental variable"

  HYPRLAND_CONF="$HOME/.local/share/anarchy/config/hypr/hyprland.conf"
...
check_or_install_nvidia_driver() {
